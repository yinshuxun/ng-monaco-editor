...
define(['require', 'exports'], function(require, exports) {
  ...
  var DiagnostcsAdapter = /** @class */ (function(_super) {
    ...
    function DiagnostcsAdapter(_defaults, _selector, worker) {
      ...
      _this._disposables.push({
        dispose: function() {
          for (
            var _i = 0, _a = monaco.editor.getModels();
            _i < _a.length;
            _i++
          ) {
            var model = _a[_i];
      ...
      _this._disposables.push(
        _this._defaults.onDidChange(function() {
  ...
  var SuggestAdapter = /** @class */ (function(_super) {
    ...
    SuggestAdapter.prototype.resolveCompletionItem = function(
      _model,
      _position,
      item,
      token,
  ...
  var SignatureHelpAdapter = /** @class */ (function(_super) {
    ...
    SignatureHelpAdapter.prototype.provideSignatureHelp = function(
      model,
      position,
      token,
    ) {
  ...
  var OccurrencesAdapter = /** @class */ (function(_super) {
    ...
    OccurrencesAdapter.prototype.provideDocumentHighlights = function(
      model,
      position,
      token,
    ) {
