  ...
  (function(WorkspaceEdit) {
    function is(value) {
      ...
      return (
        ...
        (candidate.documentChanges === void 0 ||
          Is.typedArray(candidate.documentChanges, TextDocumentEdit.is))
      );
    }
    WorkspaceEdit.is = is;
...
(function(factory) {
  ...
  function format(documentText, range, options) {
    ...
    function scanNext() {
      ...
      hasError =
        token === 16 /* Unknown */ || scanner.getTokenError() !== 0 /* None */;
      return token;
    }
    var editOperations = [];
    ...
    while (firstToken !== 17 /* EOF */) {
      ...
      while (
        ...
        firstTokenEnd =
          scanner.getTokenOffset() + scanner.getTokenLength() + formatTextStart;
        replaceContent =
          secondToken === 12 /* LineCommentTrivia */ ? newLineAndIndent() : '';
    ...
    JSONDocument.prototype.validate = function(textDocument, schema) {
      if (this.root && schema) {
        ...
        return validationResult.problems.map(function(p) {
          ...
          return vscode_languageserver_types_1.Diagnostic.create(
            range,
            p.message,
            p.severity,
            p.code,
                ...
                if (typeof propertySchema === 'boolean') {
                  if (!propertySchema) {
                    ...
                    validationResult.problems.push({
                      ...
                      severity:
                        vscode_languageserver_types_1.DiagnosticSeverity
                          .Warning,
                      message:
                        schema.errorMessage ||
                        localize(
  ...
  function parse(textDocument, config) {
    ...
    function _errorAtRange(message, code, startOffset, endOffset, severity) {
      ...
      if (problems.length === 0 || startOffset !== lastProblemOffset) {
        ...
        problems.push(
          vscode_languageserver_types_1.Diagnostic.create(
            range,
            message,
            severity,
            code,
      ...
      while (
        ...
        if (scanner.getToken() === 5 /* CommaToken */) {
          ...
          _error(
            ...
            jsonLanguageTypes_1.ErrorCode.CommaExpected,
          );
        }
    ...
    function _parseProperty(parent, keysSeen) {
      ...
      if (scanner.getToken() === 6 /* ColonToken */) {
        ...
        _error(
          ...
          jsonLanguageTypes_1.ErrorCode.ColonExpected,
        );
        if (
  ...
  var JSONCompletion = /** @class */ (function() {
    ...
    JSONCompletion.prototype.doComplete = function(document, position, doc) {
      ...
      if (
        ...
        overwriteRange = vscode_languageserver_types_1.Range.create(
      ...
      var collector = {
        add: function(suggestion) {
          ...
          if (!existing) {
            ...
            if (overwriteRange) {
              suggestion.textEdit = vscode_languageserver_types_1.TextEdit.replace(
                overwriteRange,
          ...
          if (node && node.type === 'object') {
            ...
            properties.forEach(function(p) {
              if (!currentProperty || currentProperty !== p) {
                proposed[
                  p.keyNode.value
                ] = vscode_languageserver_types_1.CompletionItem.create('__');
              }
            });
          ...
          if (schemaProperties_1) {
            Object.keys(schemaProperties_1).forEach(function(key) {
              ...
              if (
                ...
                if (
                  strings_1.endsWith(proposal.insertText, '$1' + separatorAfter)
                ) {
                  proposal.command = {
                    title: 'Suggest',
...
(function(factory) {
  ...
  var JSONHover = /** @class */ (function() {
    ...
    JSONHover.prototype.doHover = function(document, position, doc) {
      ...
      var hoverRange = vscode_languageserver_types_1.Range.create(
...
(function(factory) {
            ...
            for (
              ...
              if (
                ...
                if (!visitedNode[nodeId]) {
                  var color = colors_1.colorFromHex(
  ...
  function getRange(document, node) {
    return vscode_languageserver_types_1.Range.create(
      document.positionAt(node.offset),
      document.positionAt(node.offset + node.length),
    );
  }
    ...
    ResolvedSchema.prototype.getSectionRecursive = function(path, schema) {
      ...
      if (schema.properties && typeof schema.properties[next]) {
        ...
        Object.keys(schema.patternProperties).forEach(function(pattern) {
          ...
          if (regex.test(next)) {
            return _this.getSectionRecursive(
              path,
      ...
      switch (token) {
        ...
        case 13 /* BlockCommentTrivia */: {
          ...
          if (
            ...
            scanner.setPosition(
              document.offsetAt(
                vscode_languageserver_types_1.Position.create(startLine + 1, 0),
              ),
            );
          } else {
        ...
        case 12 /* LineCommentTrivia */: {
          ...
          if (m) {
            ...
            if (m[1]) {
              ...
              while (
                i >= 0 &&
                stack[i].kind !== jsonLanguageTypes_1.FoldingRangeKind.Region
              ) {
                i--;
              }
              if (i >= 0) {
...
(function(factory) {
  ...
  function getLanguageService(params) {
    ...
    jsonSchemaService.setSchemaContributions(
      configuration_1.schemaContributions,
    );
    ...
    var jsonHover = new jsonHover_1.JSONHover(
      jsonSchemaService,
      params.contributions,
      promise,
    );
    ...
    var jsonValidation = new jsonValidation_1.JSONValidation(
      jsonSchemaService,
      promise,
    );
    return {
      ...
      format: function(d, r, o) {
        ...
        return jsonc_parser_1
          .format(d.getText(), range, options)
          .map(function(e) {
...
define('vs/language/json/jsonWorker', [
  ...
  'vscode-languageserver-types',
], function(require, exports, jsonService, ls) {
  /*---------------------------------------------------------------------------------------------
   *  Copyright (c) Microsoft Corporation. All rights reserved.
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
