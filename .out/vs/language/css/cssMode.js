define('vs/language/css/workerManager', ['require', 'exports'], function(
  require,
  exports,
) {
  /*---------------------------------------------------------------------------------------------
...
define('vs/language/css/languageFeatures', [
  ...
  var DocumentHighlightAdapter = /** @class */ (function() {
    ...
    DocumentHighlightAdapter.prototype.provideDocumentHighlights = function(
      model,
      position,
      token,
    ) {
  ...
  var DefinitionAdapter = /** @class */ (function() {
    ...
    DefinitionAdapter.prototype.provideDefinition = function(
      model,
      position,
      token,
    ) {
  ...
  var ReferenceAdapter = /** @class */ (function() {
    ...
    ReferenceAdapter.prototype.provideReferences = function(
      model,
      position,
      context,
      token,
  ...
  var RenameAdapter = /** @class */ (function() {
    ...
    RenameAdapter.prototype.provideRenameEdits = function(
      model,
      position,
      newName,
      token,
  ...
  var DocumentSymbolAdapter = /** @class */ (function() {
    ...
    DocumentSymbolAdapter.prototype.provideDocumentSymbols = function(
      model,
      token,
    ) {
      var resource = model.uri;
  ...
  var DocumentColorAdapter = /** @class */ (function() {
    ...
    DocumentColorAdapter.prototype.provideColorPresentations = function(
      model,
      info,
      token,
    ) {
      ...
      return this._worker(resource)
        .then(function(worker) {
          return worker.getColorPresentations(
            resource.toString(),
            info.color,
  ...
  var FoldingRangeAdapter = /** @class */ (function() {
    ...
    FoldingRangeAdapter.prototype.provideFoldingRanges = function(
      model,
      context,
      token,
    ) {
...
define('vs/language/css/cssMode', [
  ...
  './workerManager',
  './languageFeatures',
], function(require, exports, workerManager_1, languageFeatures) {
  /*---------------------------------------------------------------------------------------------
   *  Copyright (c) Microsoft Corporation. All rights reserved.
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  ...
  function setupMode(defaults) {
    ...
    var worker = function(first) {
      ...
      return client.getLanguageServiceWorker.apply(
        client,
        [first].concat(more),
      );
    };
