...
define('vs/language/json/languageFeatures', [
    ...
    DiagnosticsAdapter.prototype._doValidate = function(resource, languageId) {
      this._worker(resource)
        .then(function(worker) {
          return worker
            .doValidation(resource.toString())
  ...
  var DocumentFormattingEditProvider = /** @class */ (function() {
    ...
    DocumentFormattingEditProvider.prototype.provideDocumentFormattingEdits = function(
      model,
      options,
      token,
    ) {
  ...
  function tokenize(comments, line, state, offsetDelta, stopAtOffset) {
    ...
    while (true) {
      ...
      switch (kind) {
        ...
        case 10 /* StringLiteral */:
          type = lastWasColon
            ? exports.TOKEN_VALUE_STRING
            : exports.TOKEN_PROPERTY_NAME;
          lastWasColon = false;
          break;
        case 11 /* NumericLiteral */:
  ...
  function setupMode(defaults) {
    ...
    disposables.push(
      monaco.languages.setTokensProvider(
        languageId,
        tokenization_1.createTokenizationSupport(true),
      ),
    );
    disposables.push(
