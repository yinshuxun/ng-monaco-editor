...
(function() {
  ...
  (function(AMDLoader) {
    var ConfigurationOptionsUtil = (function() {
      ...
      ConfigurationOptionsUtil.validateConfigurationOptions = function(
        ...
        if (
          typeof options.ignoreDuplicateModules !== 'object' ||
          !Array.isArray(options.ignoreDuplicateModules)
        ) {
        ...
        if (
          typeof options.nodeCachedDataWriteDelay !== 'number' ||
          options.nodeCachedDataWriteDelay < 0
        ) {
        ...
        if (typeof options.onNodeCachedData !== 'function') {
          options.onNodeCachedData = function(err, data) {
            if (!err) {
              ...
              err.errorCode === 'unlink' ||
              err.errorCode === 'writeFile'
            ) {
      ...
      ConfigurationOptionsUtil.mergeConfigurationOptions = function(
        ...
        AMDLoader.Utilities.forEachProperty(overwrite, function(key, value) {
          if (
            ...
            result.ignoreDuplicateModules = result.ignoreDuplicateModules.concat(
              value,
            );
    ...
    var Configuration = (function() {
      function Configuration(env, options) {
        this._env = env;
        this.options = ConfigurationOptionsUtil.mergeConfigurationOptions(
          options,
        );
      ...
      Configuration.prototype._createSortedPathsRules = function() {
        ...
        AMDLoader.Utilities.forEachProperty(this.options.paths, function(
          from,
          to,
        ) {
          if (!Array.isArray(to)) {
  ...
  (function(AMDLoader) {
    ...
    var NodeScriptLoader = (function() {
      ...
      NodeScriptLoader.prototype._initNodeRequire = function(
        ...
        var nodeCachedDataDir = moduleManager.getConfig().getOptionsLiteral()
          .nodeCachedDataDir;
      ...
      NodeScriptLoader.prototype.load = function(
        ...
        if (/^node\|/.test(scriptSrc)) {
          ...
          this._fs.readFile(scriptSrc, { encoding: 'utf8' }, function(
            err,
            data,
          ) {
            if (err) {
            ...
            if (!opts.nodeCachedDataDir) {
              ...
              var cachedDataPath_1 = _this._getCachedDataPath(
                opts.nodeCachedDataDir,
                scriptSrc,
              );
              _this._fs.readFile(cachedDataPath_1, function(err, cachedData) {
                ...
                var script = _this._loadAndEvalScript(
                  moduleManager,
                  scriptSrc,
                  vmScriptSrc,
                  contents,
      ...
      NodeScriptLoader.prototype._loadAndEvalScript = function(
        moduleManager,
        scriptSrc,
        vmScriptSrc,
        contents,
        ...
        if (receivedDefineCall) {
          ...
          errorback(
            new Error("Didn't receive define call in " + scriptSrc + '!'),
          );
        }
        return script;
      };
      ...
      NodeScriptLoader.prototype._processCachedData = function(
        moduleManager,
        script,
        cachedDataPath,
      ) {
        ...
        if (script.cachedDataRejected) {
          ...
          NodeScriptLoader._runSoon(function() {
            ...
            .getConfig()
            .getOptionsLiteral().nodeCachedDataWriteDelay);
        } else if (script.cachedDataProduced) {
          // data produced => tell outside world
          moduleManager
            .getConfig()
            .getOptionsLiteral()
            .onNodeCachedData(undefined, {
              path: cachedDataPath,
              length: script.cachedData.length,
            });
          // data produced => write cache file
          NodeScriptLoader._runSoon(function() {
            return _this._fs.writeFile(
              cachedDataPath,
              script.cachedData,
              function(err) {
                if (err) {
    ...
    var ModuleManager = (function() {
      ...
      ModuleManager.prototype.defineModule = function(
        ...
        if (this._config.isBuild()) {
          ...
          this._buildInfoDependencies[moduleId] = m.dependencies.map(function(
            dep,
          ) {
  ...
  (function(AMDLoader) {
    ...
    function init() {
      if (
        ...
        if (
          typeof _nodeRequire_1 === 'function' &&
          typeof _nodeRequire_1.resolve === 'function'
        ) {
          // re-expose node's require function
          var nodeRequire = function(what) {
            moduleManager
              .getRecorder()
              .record(33 /* NodeBeginNativeRequire */, what);
            try {
              return _nodeRequire_1(what);
            } finally {
              moduleManager
                .getRecorder()
                .record(34 /* NodeEndNativeRequire */, what);
            }
          };
  ...
  define(__m[24 /*vs/base/common/arrays*/], __M([
    0 /*require*/,
    1 /*exports*/,
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[20 /*vs/base/common/diff/diffChange*/], __M([
    0 /*require*/,
    1 /*exports*/,
  ]), function(require, exports) {
    'use strict';
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[13 /*vs/base/common/diff/diff*/], __M([
    0 /*require*/,
    1 /*exports*/,
    20 /*vs/base/common/diff/diffChange*/,
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[16 /*vs/base/common/functional*/], __M([
    0 /*require*/,
    1 /*exports*/,
  ]), function(require, exports) {
    'use strict';
  ...
  define(__m[12 /*vs/base/common/iterator*/], __M([
    0 /*require*/,
    1 /*exports*/,
  ]), function(require, exports) {
    'use strict';
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[21 /*vs/base/common/keyCodes*/], __M([
    0 /*require*/,
    1 /*exports*/,
  ]), function(require, exports) {
    'use strict';
  ...
  define(__m[7 /*vs/base/common/lifecycle*/], __M([
    0 /*require*/,
    1 /*exports*/,
  ]), function(require, exports) {
    'use strict';
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[15 /*vs/base/common/linkedList*/], __M([
    0 /*require*/,
    1 /*exports*/,
    12 /*vs/base/common/iterator*/,
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[3 /*vs/base/common/platform*/], __M([
    0 /*require*/,
    1 /*exports*/,
  ]), function(require, exports) {
    'use strict';
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[17 /*vs/base/common/strings*/], __M([
    0 /*require*/,
    1 /*exports*/,
  ]), function(require, exports) {
    'use strict';
  ...
  define(__m[11 /*vs/base/common/uri*/], __M([
    0 /*require*/,
    1 /*exports*/,
  ...
  (function() {
            ...
            if (member && typeof member === 'object') {
              if (
                ...
                if (
                  prefix &&
                  member.setName &&
                  typeof member.setName === 'function'
                ) {
              ...
              get: function() {
                switch (state) {
                  ...
                  case LazyStates.uninitialized:
                    ...
                    try {
                      _WriteProfilerMark(
                        'WinJS.Namespace._lazy:' + name + ',StartTM',
                      );
                      result = f();
                    } finally {
                      _WriteProfilerMark(
                        'WinJS.Namespace._lazy:' + name + ',StopTM',
                      );
    ...
    _winjs(
      ...
      function errorsInit(_Base) {
        ...
        var ErrorFromName = _Base.Class.derive(
          Error,
    ...
    _winjs('WinJS/Core/_Trace', ['WinJS/Core/_Global'], function traceInit(
      _Global,
    ) {
      'use strict';
      ...
      return {
        _traceAsyncOperationStarting:
          (_Global.Debug &&
            ...
            _Global.Debug.msTraceAsyncOperationStarting.bind(_Global.Debug)) ||
          nop,
        _traceAsyncOperationCompleted:
          (_Global.Debug &&
            _Global.Debug.msTraceAsyncOperationCompleted &&
            _Global.Debug.msTraceAsyncOperationCompleted.bind(_Global.Debug)) ||
          nop,
        _traceAsyncCallbackStarting:
          (_Global.Debug &&
            _Global.Debug.msTraceAsyncCallbackStarting &&
            _Global.Debug.msTraceAsyncCallbackStarting.bind(_Global.Debug)) ||
          nop,
        _traceAsyncCallbackCompleted:
          (_Global.Debug &&
            _Global.Debug.msTraceAsyncCallbackCompleted &&
            _Global.Debug.msTraceAsyncCallbackCompleted.bind(_Global.Debug)) ||
          nop,
      };
    });
    _winjs(
      ...
      function promiseStateMachineInit(
        _Global,
        _BaseCoreUtils,
        _Base,
        _ErrorFromName,
        ...
        var ListenerType = _Base.Class.mix(
          _Base.Class.define(
            null,
            {
              /*empty*/
        ...
        state_waiting = {
          ...
          enter: function(promise) {
            ...
            if (
              waitedUpon instanceof ThenPromise &&
        ...
        var PromiseStateMachine = _Base.Class.define(
          null,
          {
            _listeners: null,
            _nextState: null,
            ...
            _chainedError: function(value, context) {
              var result = this._state._error(
                this,
                value,
                detailsForChainedError,
                context,
              );
              this._run();
              return result;
            ...
            _setChainedErrorValue: function(value, context) {
              var result = this._state._setErrorValue(
                this,
                value,
                detailsForChainedError,
                context,
        ...
        function done(promise, onComplete, onError, onProgress) {
          var asyncOpID = _Trace._traceAsyncOperationStarting(
            'WinJS.Promise.done',
          );
        ...
        function notifySuccess(promise, queue) {
          ...
          var i, len;
          for (
            i = 0, len = Array.isArray(listeners) ? listeners.length : 1;
            i < len;
            i++
          ) {
            ...
            _Trace._traceAsyncOperationCompleted(
              listener.asyncOpID,
              _Global.Debug && _Global.Debug.MS_ASYNC_OP_STATUS_SUCCESS,
            );

            if (target) {
              _Trace._traceAsyncCallbackStarting(listener.asyncOpID);
              try {
                target._setCompleteValue(
                  onComplete ? onComplete(value) : value,
                );
              } catch (ex) {
        ...
        function notifyError(promise, queue) {
          ...
          for (
            ...
            var errorID =
              _Global.Debug &&
              (value && value.name === canceledName
                ? _Global.Debug.MS_ASYNC_OP_STATUS_CANCELED
                : _Global.Debug.MS_ASYNC_OP_STATUS_ERROR);
        ...
        function callonerror(
          ...
          if (promiseEventListeners._listeners[errorET]) {
            ...
            promiseEventListeners.dispatchEvent(
              errorET,
              onerrorDetailsGenerator(promise, value, context, handler),
            );
          }
        }
        ...
        //
        var ThenPromise = _Base.Class.derive(
          PromiseStateMachine,
          function(creator) {
            if (
              tagWithStack &&
              (tagWithStack === true || tagWithStack & tag.thenPromise)
            ) {
        ...
        var ErrorPromise = _Base.Class.define(
          function ErrorPromise_ctor(value) {
            if (
              tagWithStack &&
              (tagWithStack === true || tagWithStack & tag.errorPromise)
            ) {
              this._stack = Promise._getStack();
            }
        ...
        var ExceptionPromise = _Base.Class.derive(
          ErrorPromise,
          function ExceptionPromise_ctor(value) {
            if (
              tagWithStack &&
              (tagWithStack === true || tagWithStack & tag.exceptionPromise)
            ) {
              this._stack = Promise._getStack();
            }
        ...
        var CompletePromise = _Base.Class.define(
          function CompletePromise_ctor(value) {
            if (
              tagWithStack &&
              (tagWithStack === true || tagWithStack & tag.completePromise)
            ) {
              this._stack = Promise._getStack();
            }
          ...
          },
          {
            ...
            then: function CompletePromise_then(onComplete) {
              ...
              try {
                ...
                //
                var newValue = onComplete
                  ? onComplete(this._value)
                  : this._value;
                return newValue === this._value
                  ? this
                  : new CompletePromise(newValue);
              } catch (ex) {
        ...
        var Promise = _Base.Class.derive(
          PromiseStateMachine,
          function Promise_ctor(init, oncancel) {
            ...
            if (
              tagWithStack &&
              (tagWithStack === true || tagWithStack & tag.promise)
            ) {
              this._stack = Promise._getStack();
            }
          ...
          {
            addEventListener: function Promise_addEventListener(
              eventType,
              listener,
              capture,
            ) {
              ...
              /// </param>
              /// </signature>
              promiseEventListeners.addEventListener(
                eventType,
                listener,
                capture,
              );
            ...
            cancel: {
              get: function() {
                return (staticCanceledPromise =
                  staticCanceledPromise ||
                  new ErrorPromise(new _ErrorFromName(canceledName)));
              },
            },
            ...
            removeEventListener: function Promise_removeEventListener(
              eventType,
              listener,
              capture,
            ) {
              ...
              /// </param>
              /// </signature>
              promiseEventListeners.removeEventListener(
                eventType,
                listener,
                capture,
              );
            ...
            thenEach: function Promise_thenEach(
              ...
              Object.keys(values).forEach(function(key) {
                result[key] = Promise.as(values[key]).then(
                  onComplete,
                  onError,
                  onProgress,
                );
        ...
        Object.defineProperties(
          Promise,
          _Events.createEventProperties(errorET),
        );
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[4 /*vs/base/common/errors*/], __M([
    0 /*require*/,
    1 /*exports*/,
    8 /*vs/base/common/winjs.base*/,
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[9 /*vs/base/common/event*/], __M([
    0 /*require*/,
    1 /*exports*/,
    4 /*vs/base/common/errors*/,
    16 /*vs/base/common/functional*/,
    7 /*vs/base/common/lifecycle*/,
    15 /*vs/base/common/linkedList*/,
  ]), function(
    require,
    exports,
    errors_1,
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[10 /*vs/base/common/cancellation*/], __M([
    0 /*require*/,
    1 /*exports*/,
    9 /*vs/base/common/event*/,
  ...
  define(__m[14 /*vs/base/common/async*/], __M([
    0 /*require*/,
    1 /*exports*/,
    10 /*vs/base/common/cancellation*/,
    4 /*vs/base/common/errors*/,
    7 /*vs/base/common/lifecycle*/,
    8 /*vs/base/common/winjs.base*/,
  ]), function(
      ...
      if (
        ...
        exports.runWhenIdle = function(runner, timeout) {
          var handle = requestIdleCallback(
            runner,
            typeof timeout === 'number' ? { timeout: timeout } : undefined,
          );
          var disposed = false;
          return {
            dispose: function() {
    ...
    var IdleValue = /** @class */ (function() {
      function IdleValue(executor) {
        ...
        this._handle = exports.runWhenIdle(function() {
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[18 /*vs/base/common/winjs.polyfill.promise*/], __M([
    0 /*require*/,
    1 /*exports*/,
    8 /*vs/base/common/winjs.base*/,
    3 /*vs/base/common/platform*/,
    14 /*vs/base/common/async*/,
  ]), function(require, exports, winjs_base_1, platform, async_1) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
    function isWinJSPromise(candidate) {
      return (
        async_1.isThenable(candidate) && typeof candidate.done === 'function'
      );
    }
    /**
    ...
    var PolyfillPromise = /** @class */ (function() {
      function PolyfillPromise(initOrPromise) {
        if (isWinJSPromise(initOrPromise)) {
          ...
          this._winjsPromise = new winjs_base_1.Promise(function(
            resolve,
            reject,
          ) {
      ...
      PolyfillPromise.all = function(thenables) {
        return new PolyfillPromise(
          winjs_base_1.Promise.join(thenables).then(null, function(values) {
      ...
      PolyfillPromise.race = function(thenables) {
        ...
        return new PolyfillPromise(
          winjs_base_1.Promise.any(thenables).then(
            function(entry) {
              return entry.value;
            },
            function(err) {
      ...
      PolyfillPromise.prototype.then = function(onFulfilled, onRejected) {
        ...
        var promise = new PolyfillPromise(
          this._winjsPromise.then(
            onFulfilled &&
              function(value) {
                if (!sync) {
  ...
  define(__m[33 /*vs/base/common/worker/simpleWorker*/], __M([
    ...
    7 /*vs/base/common/lifecycle*/,
    3 /*vs/base/common/platform*/,
    18 /*vs/base/common/winjs.polyfill.promise*/,
  ]), function(
    require,
    exports,
    errors_1,
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[2 /*vs/editor/common/core/position*/], __M([
    0 /*require*/,
    1 /*exports*/,
  ]), function(require, exports) {
    'use strict';
  ...
  define(__m[22 /*vs/editor/common/core/selection*/], __M([
    0 /*require*/,
    1 /*exports*/,
    2 /*vs/editor/common/core/position*/,
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[23 /*vs/editor/common/core/token*/], __M([
    0 /*require*/,
    1 /*exports*/,
  ]), function(require, exports) {
    'use strict';
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[6 /*vs/editor/common/core/uint*/], __M([
    0 /*require*/,
    1 /*exports*/,
  ]), function(require, exports) {
    'use strict';
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[25 /*vs/editor/common/core/characterClassifier*/], __M([
    0 /*require*/,
    1 /*exports*/,
    6 /*vs/editor/common/core/uint*/,
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[26 /*vs/editor/common/diff/diffComputer*/], __M([
    0 /*require*/,
    1 /*exports*/,
    13 /*vs/base/common/diff/diff*/,
    17 /*vs/base/common/strings*/,
    ...
    function computeDiff(
      ...
      var diffAlgo = new diff_1.LcsDiff(
        originalSequence,
        modifiedSequence,
        continueProcessingPredicate,
      );
    ...
    var LineChange = /** @class */ (function() {
      ...
      LineChange.createFromDiffResult = function(
        ...
        if (diffChange.originalLength === 0) {
          originalStartLineNumber =
            originalLineSequence.getStartLineNumber(diffChange.originalStart) -
            1;
          originalEndLineNumber = 0;
        } else {
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[27 /*vs/editor/common/model/wordHelper*/], __M([
    0 /*require*/,
    1 /*exports*/,
  ]), function(require, exports) {
    'use strict';
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[28 /*vs/editor/common/modes/linkComputer*/], __M([
    0 /*require*/,
    1 /*exports*/,
    25 /*vs/editor/common/core/characterClassifier*/,
    6 /*vs/editor/common/core/uint*/,
    ...
    var StateMachine = /** @class */ (function() {
      function StateMachine(edges) {
        ...
        maxCharCode++;
        maxState++;
        var states = new uint_1.Uint8Matrix(
          maxState,
          maxCharCode,
          0 /* Invalid */,
        );
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[29 /*vs/editor/common/modes/supports/inplaceReplaceSupport*/], __M(
    [0 /*require*/, 1 /*exports*/],
  ), function(require, exports) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[30 /*vs/editor/common/standalone/standaloneEnums*/], __M([
    0 /*require*/,
    1 /*exports*/,
  ]), function(require, exports) {
    'use strict';
    ...
    (function(SignatureHelpTriggerReason) {
      SignatureHelpTriggerReason[(SignatureHelpTriggerReason['Invoke'] = 1)] =
        'Invoke';
      SignatureHelpTriggerReason[
        (SignatureHelpTriggerReason['TriggerCharacter'] = 2)
      ] = 'TriggerCharacter';
      SignatureHelpTriggerReason[
        (SignatureHelpTriggerReason['ContentChange'] = 3)
      ] = 'ContentChange';
    })(
      (SignatureHelpTriggerReason =
        exports.SignatureHelpTriggerReason ||
        (exports.SignatureHelpTriggerReason = {})),
    );
    /**
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[31 /*vs/editor/common/standalone/standaloneBase*/], __M([
    0 /*require*/,
    1 /*exports*/,
    10 /*vs/base/common/cancellation*/,
    9 /*vs/base/common/event*/,
    21 /*vs/base/common/keyCodes*/,
    11 /*vs/base/common/uri*/,
    8 /*vs/base/common/winjs.base*/,
    2 /*vs/editor/common/core/position*/,
    5 /*vs/editor/common/core/range*/,
    22 /*vs/editor/common/core/selection*/,
    23 /*vs/editor/common/core/token*/,
    30 /*vs/editor/common/standalone/standaloneEnums*/,
  ]), function(
    require,
    exports,
    cancellation_1,
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[32 /*vs/editor/common/viewModel/prefixSumComputer*/], __M([
    0 /*require*/,
    1 /*exports*/,
    6 /*vs/editor/common/core/uint*/,
  ]), function(require, exports, uint_1) {
   ...
   *  Licensed under the MIT License. See License.txt in the project root for license information.
   *--------------------------------------------------------------------------------------------*/
  define(__m[19 /*vs/editor/common/model/mirrorTextModel*/], __M([
    0 /*require*/,
    1 /*exports*/,
    2 /*vs/editor/common/core/position*/,
    32 /*vs/editor/common/viewModel/prefixSumComputer*/,
  ...
  define(__m[34 /*vs/editor/common/services/editorSimpleWorker*/], __M([
    ...
    2 /*vs/editor/common/core/position*/,
    5 /*vs/editor/common/core/range*/,
    26 /*vs/editor/common/diff/diffComputer*/,
    19 /*vs/editor/common/model/mirrorTextModel*/,
    27 /*vs/editor/common/model/wordHelper*/,
    28 /*vs/editor/common/modes/linkComputer*/,
    29 /*vs/editor/common/modes/supports/inplaceReplaceSupport*/,
    31 /*vs/editor/common/standalone/standaloneBase*/,
  ]), function(
    require,
    exports,
    arrays_1,
    ...
    var MirrorModel = /** @class */ (function(_super) {
      ...
      MirrorModel.prototype.getWordAtPosition = function(
        ...
        var wordAtText = wordHelper_1.getWordAtText(
          position.column,
    ...
    var BaseEditorSimpleWorker = /** @class */ (function() {
      ...
      BaseEditorSimpleWorker.prototype.computeDiff = function(
        ...
        var diffComputer = new diffComputer_1.DiffComputer(
          originalLines,
          modifiedLines,
          {
      ...
      BaseEditorSimpleWorker.prototype.navigateValueSet = function(
        ...
        var result = inplaceReplaceSupport_1.BasicInplaceReplace.INSTANCE.navigateValueSet(
          range,
          selectionText,
          wordRange,
          word,
